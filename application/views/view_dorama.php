	...
	<div id ="main">
    	<div class="container">
            ...
            <div id ="block_featured" class="block">            	
                ...
                <div id="accordion">
					<div>
						<h3><a href=""><?php echo anchor ('welcome_2/Litter','1 Litter Of Tears'); ?></a></h3>
						<div><img src="/TugasDPW/images/10PromiseToMyDog.JPG"/>
					...
					<div>
						<h3><a href=""><?php echo anchor ('welcome_2/promises','10 Promises to My Dog'); ?></a></h3>
